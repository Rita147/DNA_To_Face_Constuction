...
# .../FLAME_PyTorch/flame_pytorch/config.py
_THIS_DIR = Path(__file__).resolve().parent          # .../FLAME_PyTorch/flame_pytorch
_PROJECT_DIR = _THIS_DIR.parent                      # .../FLAME_PyTorch
_MODEL_DIR = _PROJECT_DIR / "model"

parser.add_argument(
    "--flame_model_path",
    type=str,
    default=str(_MODEL_DIR / "generic_model.pkl"),
...
parser.add_argument(
    ...
    type=str,
    default=str(_MODEL_DIR / "flame_static_embedding.pkl"),
...
parser.add_argument(
    ...
    type=str,
    default=str(_MODEL_DIR / "flame_dynamic_embedding.npy"),
