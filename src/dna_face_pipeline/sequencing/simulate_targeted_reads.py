...
INPUT_GENOMES = PROJECT_ROOT / "data" / "synthetic_dataset" / "synthetic_genotypes.csv"
OUTPUT_DIR = PROJECT_ROOT / "data" / "sequencing_outputs"
...
def main() -> None:
    ...
    reads_csv_path = args.output_dir / "simulated_targeted_reads.csv"
    reads_fastq_path = args.output_dir / "simulated_targeted_reads.fastq"
    selected_genotypes_path = args.output_dir / "reference_genotypes_for_simulation.csv"
    metadata_path = args.output_dir / "sequencing_simulation_metadata.json"
