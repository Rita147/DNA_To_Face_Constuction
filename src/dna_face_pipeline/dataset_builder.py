...
DEFAULT_OUTPUT_DIR = Path(__file__).resolve().parents[2] / "data" / "synthetic_dataset"
...
def generate_extended_dataset(n_samples: int = 1000, output_dir: Optional[Path] = None):
    ...
    # Save
    genomes_path = output_dir / "synthetic_genotypes.csv"
    phenotypes_path = output_dir / "predicted_phenotypes.csv"
    prompts_path = output_dir / "face_generation_prompts.csv"
    complete_path = output_dir / "synthetic_dataset_complete.csv"
    ...
    print(f"   They can use the phenotype and prompt columns to generate detailed faces")
    print("="*70)
