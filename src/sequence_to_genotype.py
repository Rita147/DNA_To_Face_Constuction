...
INPUT_DIR = Path(__file__).parent / "extended_facial_data" / "sequencing_sim"
...
def main() -> None:
    ...
    reads_path = args.input_dir / "simulated_reads.csv"
    catalog_path = args.input_dir / "reference_snp_catalog.csv"
    truth_path = args.input_dir / "true_genotypes.csv"
    ...
    calls_path = args.input_dir / "called_genotypes.csv"
